        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChoreAssignments_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notes_Tenants_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_Tenants_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentShares_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentShares_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChoreAssignments_TenantId",
                table: "ChoreAssignments",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_Chores_FlatId",
                table: "Chores",
                column: "FlatId");

            migrationBuilder.CreateIndex(
                name: "IX_Flats_AccessCode",
                table: "Flats",
                column: "AccessCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentShares_PaymentId",
                table: "PaymentShares",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentShares_TenantId",
                table: "PaymentShares",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_Tenants_FlatId_UserId",
                table: "Tenants",
